...
**Inspired from Anderoo's WxPyBrowser** : https://github.com/Andereoo/WxPyBrowser

----------------
PLANS: WORKING ON IMPROVEMENTS TO UPDATE FEATURE (IT'S UNDER DEVELOPMENT) SO DON'T USE IT CURRENTLY, AND WE RECOMMEND TO ALWAYS USE THE CODE VERSION OF THE APP, NOT THE EXE ONE, SO JUST DOWNLOAD THE CODE AS ZIP AND USE IT,
OR YOU CAN JUST INSTALL THE WINDOWS APPLICATION VERSION IT'S YOUR CHOICE, BUT I RECOMMEND THE TO RUN THE BROWSER IN THE CODE FORM
----------------

<h3>-THE 1.8G2 UPDATE (AKA 'Kakudai flowers2') (NONE):</h3>
